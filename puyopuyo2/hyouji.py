...
def allhyouji(field1,field2,puyo_1,puyo_2,screen,font):
  ...
  alltokuten1 = field1.tokuten.hyouji
  alltokuten2 = field2.tokuten.hyouji
  tokutenhyouji=font.render(str(alltokuten1),False,(0,0,0))
  screen.blit(tokutenhyouji,(155,660))
  tokutenhyouji2=font.render(str(alltokuten2),False,(0,0,0))
  screen.blit(tokutenhyouji2,(695,660))
  if field1.rensa_c!=0:
  ...
  ojamahyouji(field1.tokuten.atack + field1.tokuten.behind,field1.ojama,screen)
  ojamahyouji_2(field2.tokuten.atack + field2.tokuten.behind,field2.ojama,screen)
