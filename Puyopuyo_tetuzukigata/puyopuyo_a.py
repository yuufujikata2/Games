...
def kaitenhantei(haichi2,puyo1,puyo2,x):
  ...
  if x==2:
    if puyo1[2]-1==puyo2[2]:
      ...
      return 4
  return 0
def cpu_sousa(haichi2_2,puyo1_2,puyo2_2,x):
  ...
  if x==5:
    if puyo2_2[1]<5:
      ...
      shita_c_2+=1
  if x==6:
    if haichi2_2[11][1]==0 and haichi2_2[11][3]==0:
...
class Player2(threading.Thread):
  ...
  def run (self):
    ...
    while True:
      ...
      suri2=-11
      rakkab_c=0
      cpu_c=cpu1(haichi2,puyo1_2,puyo2_2)
      while True:
        clock.tick(60)
        surinukecount+=1
        surinukecount2+=1
        ...
        cpu_sousa(haichi2,puyo1_2,puyo2_2,cpu_c)
        if hidari_c_2>=10:
