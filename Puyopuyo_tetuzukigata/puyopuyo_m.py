...
def ojamarakka(haichi,haichi_2,nexnex,nexnex_2,ojama,ojama_2,counttotal,counttotal_2,counttotal2,counttotal2_2,screen,zenkeshihyouji,zenkeshihyouji_2):
  if counttotal>=2100:
    ...
    allhyouji(haichi,haichi_2,nexnex,nexnex_2,ojama,ojama_2,0,counttotal_2,counttotal2,counttotal2_2,screen,rensa_c,rensa_c_2,zenkeshihyouji,zenkeshihyouji_2)
    sokurakka_2(haichi,haichi_2,18,nexnex,nexnex_2,ojama,ojama_2,0,counttotal_2,counttotal2,counttotal2_2,screen,zenkeshihyouji,zenkeshihyouji_2)
    haichi_2.pop(17)
    haichi_2.pop(16)
    haichi_2.pop(15)
    haichi_2.pop(14)
...
def ojamarakka_2(haichi,haichi_2,nexnex,nexnex_2,ojama,ojama_2,counttotal,counttotal_2,counttotal2,counttotal2_2,screen,zenkeshihyouji,zenkeshihyouji_2):
  if counttotal_2>=2100:
    ...
    allhyouji(haichi,haichi_2,nexnex,nexnex_2,ojama,ojama_2,0,counttotal_2,counttotal2,counttotal2_2,screen,rensa_c,rensa_c_2,zenkeshihyouji,zenkeshihyouji_2)
    sokurakka(haichi,haichi_2,18,nexnex,nexnex_2,ojama,ojama_2,0,counttotal_2,counttotal2,counttotal2_2,screen,zenkeshihyouji,zenkeshihyouji_2)
    haichi.pop(17)
    haichi.pop(16)
    haichi.pop(15)
    haichi.pop(14)
  ...
  def run (self):
    ...
    while True:
      ...
      while True:
        ...
        if haichi[11][2]!=0 and rakkacount>=50:
          pygame.quit()
          sys.exit()
        if rakkacount>=50:
  ...
  def run (self):
    ...
    while True:
      ...
      while True:
        ...
        if haichi_2[11][2]!=0 and rakkacount>=50:
          pygame.quit()
          sys.exit()
        if rakkacount>=50:
...
def main():
  ...
  nexnex[2]=n3
  nexnex[3]=n4
  allhyouji(haichi,haichi_2,nexnex,nexnex_2,ojama,ojama_2,counttotal,counttotal_2,counttotal2,counttotal2_2,screen,rensa_c,rensa_c_2,zenkeshihyouji)
  time.sleep(2)
  while True:
    puyo1[0]=n1
    puyo2[0]=n2
