...
def allhyouji(haichi,haichi_2,puyo1,puyo1_2,puyo2,puyo2_2,nexnex,nexnex_2,ojama,ojama_2,counttotal,counttotal_2,counttotal2,counttotal2_2,counttotal_a,counttotal_a_2,screen,rensa_c,rensa_c_2,zenkeshihyouji,zenkeshihyoji_2,haichi_c,haichi_c_2):
  ...
  tokuten_2=font.render(str(counttotal2_2),False,(0,0,0))
  screen.blit(tokuten_2,(695,660))
  counttotal_t=counttotal+counttotal_a
  counttotal_t_2=counttotal_2+counttotal_a_2
  if rensa_c!=0:
  ...
  s_haichi=copy.deepcopy(haichi)
  s_haichi_2=copy.deepcopy(haichi_2)
  if haichi_c==1:
    s_haichi[puyo1[2]][puyo1[1]]=puyo1[0]
    s_haichi[puyo2[2]][puyo2[1]]=puyo2[0]
  if haichi_c_2==1:
    s_haichi_2[puyo1_2[2]][puyo1_2[1]]=puyo1_2[0]
    s_haichi_2[puyo2_2[2]][puyo2_2[1]]=puyo2_2[0]
  hyouji(s_haichi,screen)
  hyouji_2(s_haichi_2,screen)
  hyouji2(nexnex,screen)
  hyouji2_2(nexnex_2,screen)
  ojamahyouji(counttotal_t,ojama,screen)
  ojamahyouji_2(counttotal_t_2,ojama_2,screen)
...
def ojamarakka(haichi_2,counttotal_a):
  if counttotal_a>=2100:
    ...
    haichi_2.pop(13)
    return counttotal_a
def ojamarakka_2(haichi,counttotal_a_2):
  if counttotal_a_2>=2100:
    ...
    haichi.append([0,0,0,0,0,0])
    haichi.append([0,0,0,0,0,0])
    y1=counttotal_a_2//70
    y2=counttotal_a_2%70
    counttotal_a_2=y2
    if y1>24:
      for j in range(13,17):
        for i in range(6):
...
def rakka_chigiri(haichi,y):
  ...
  while True:
    ...
    time.sleep(0.4)
  return count2
def rakka_chigiri_2(haichi_2,y):
  count2=0
  while True:
    count=0
    for j in range(1,y):
...
def rensa(haichi):
  global counttotal,counttotal_2,counttotal2,counttotal2_2,zenkeshihyouji
  global rensa_c
  global counttotal_r
  global counttotal_a,counttotal_a_2
  ...
  if k==0:
    k=1 
  if counttotal_2==0 and counttotal_a_2==0:
    counttotal+=j[0]*k*10
    ...
    counttotal_a_2-=j[0]*k*10
    counttotal2+=j[0]*k*10
    if j[0]!=0 and zenkeshihyouji==1:
      counttotal_a_2-=2100
      zenkeshihyouji=0
    if j[0]!=0 and counttotal_r!=0:
      counttotal_a_2-=counttotal_r
      counttotal_r=0
    if counttotal_a_2<0:
      counttotal-=counttotal_a_2
      counttotal_a_2=0
  else:
  ...
  if aa==1:
    return 1
  rensa(haichi)
def rensa_2(haichi_2):
  global counttotal,counttotal_2,counttotal2,counttotal2_2,zenkeshihyouji_2
  global rensa_c,rensa_c_2
  global counttotal_r_2
  global counttotal_a,counttotal_a_2
  j=renketukeshi(haichi_2)
  if j[0]!=0:
    rensa_c_2+=1
  count=0
  if rensa_c_2==1:
  ...
  if k==0:
    k=1 
  if counttotal==0 and counttotal_a==0:
    counttotal_2+=j[0]*k*10
    ...
    if j[0]!=0 and counttotal_r_2!=0:
      counttotal_2+=counttotal_r_2
      counttotal_r_2=0
  elif counttotal==0:
    counttotal_a-=j[0]*k*10
    counttotal2_2+=j[0]*k*10
    if j[0]!=0 and zenkeshihyouji_2==1:
      counttotal_a-=2100
      zenkeshihyouji=0
    if j[0]!=0 and counttotal_r!=0:
      counttotal_a-=counttotal_r_2
      counttotal_r_2=0
    if counttotal_a<0:
      counttotal_2-=counttotal_a
      counttotal_a=0
  else:
    counttotal-=j[0]*k*10
    counttotal2_2+=j[0]*k*10
  ...
  if j[0]!=0:
    time.sleep(0.8)
  aa=rakka_2(haichi_2,13)
  if aa==1:
    return 1
  rensa_2(haichi_2)
def idouhantei(haichi,puyo1,puyo2,x):
  if x==1 and puyo1[1]!=0 and puyo2[1]!=0:
    if haichi[puyo1[2]][puyo1[1]-1]==0 and haichi[puyo2[2]][puyo2[1]-1]==0 :
      return 1
  elif x==2 and  puyo1[1]!=5 and puyo2[1]!=5:
    if haichi[puyo1[2]][puyo1[1]+1]==0 and haichi[puyo2[2]][puyo2[1]+1]==0:
      return 1
  elif x==3 and puyo1[2]!=0 and puyo2[2]!=0:
    if  haichi[puyo1[2]-1][puyo1[1]]==0 and haichi[puyo2[2]-1][puyo2[1]]==0:
      return 1
  return 0
def kaitenhantei(haichi,puyo1,puyo2,x):
  if x==1:
    if puyo1[2]-1==puyo2[2]:
      if puyo1[1]==0:
        if haichi[puyo2[2]][puyo2[1]+1]==0:
          return 5
        else:
          return 7
      elif puyo1[1]==5:
        ...
        if haichi[puyo2[2]][puyo2[1]-1]==0:
          return 1
        elif haichi[puyo2[2]][puyo2[1]+1]==0:
          return 5
        else:
          return 7
      ...
      if puyo1[1]==0:
        ...
        if haichi[puyo2[2]][puyo2[1]+1]==0:
          return 3
        elif haichi[puyo1[2]][puyo1[1]-1]==0:
          return 6
        else:
          return 8
    elif puyo1[1]-1==puyo2[1]:
...
class Gamen(threading.Thread):
  ...
  def run(self):
    ...
    global haichi_c,haichi_c_2
    global counttotal_a,counttotal_a_2
    while (1):
      allhyouji(haichi,haichi_2,puyo1,puyo1_2,puyo2,puyo2_2,nexnex,nexnex_2,ojama,ojama_2,counttotal,counttotal_2,counttotal2,counttotal2_2,counttotal_a,counttotal_a_2,screen,rensa_c,rensa_c_2,zenkeshihyouji,zenkeshihyouji_2,haichi_c,haichi_c_2)
  ...
  def run (self):
    ...
    while True:
      ...
      while True:
        ...
        surinukecount2+=1
        if hidari_c>=10:
          idou=idouhantei(haichi,puyo1,puyo2,1)
          if idou==1:
            puyo1[1]-=1
            puyo2[1]-=1
          hidari_c=0
        if migi_c>=10:
          idou=idouhantei(haichi,puyo1,puyo2,2)
          if idou==1:
            puyo1[1]+=1
            puyo2[1]+=1
          migi_c=0
        ...
        if pressed_key[K_DOWN]:
          idou=idouhantei(haichi,puyo1,puyo2,3)
          if idou==1:
            idou_c+=10
            rakkab_c+=1
          elif idou==0:
        ...
        for event in pygame.event.get():
          ...
          if event.type==KEYDOWN:
            if event.key==K_a:
              kaiten=kaitenhantei(haichi,puyo1,puyo2,1)
              if kaiten==1:
                puyo1[1]-=1
                puyo1[2]-=1
              elif kaiten==2:
                ...
                puyo2[2]+=1
            if event.key==K_f:
              kaiten=kaitenhantei(haichi,puyo1,puyo2,2)
              if kaiten==1:
                puyo1[1]+=1
                puyo1[2]-=1
              elif kaiten==2:
      ...
      if countcheck!=counttotal2:
        ...
        if zenkeshicount==0:
          zenkeshihyouji=1
      if counttotal_a_2>=70:
        counttotal_a_2=ojamarakka_2(haichi,counttotal_a_2)
      if haichi[11][2]!=0 :
        pygame.quit()
        sys.exit()
      for event in pygame.event.get():
...
class Player2(threading.Thread):
  ...
  def run (self):
    ...
    while True:
      ...
      suri2=-11
      rakkab_c=0
      cpu_c=cpu1(haichi_2,puyo1_2,puyo2_2)
      while True:
        clock.tick(60)
        surinukecount+=1
        surinukecount2+=1
        cpu_sousa(haichi_2,puyo1_2,puyo2_2,cpu_c)
        if hidari_c_2>=10:
          idou=idouhantei(haichi_2,puyo1_2,puyo2_2,1)
          if idou==1:
            puyo1_2[1]-=1
            puyo2_2[1]-=1
          hidari_c_2=0
        if migi_c_2>=10:
          idou=idouhantei(haichi_2,puyo1_2,puyo2_2,2)
          if idou==1:
            puyo1_2[1]+=1
            puyo2_2[1]+=1
          migi_c_2=0
        if shita_c_2>0:
          idou=idouhantei(haichi_2,puyo1_2,puyo2_2,3)
          if idou==1:
            idou_c+=10
            rakkab_c+=1
          elif idou==0:
            setticount+=50
        if kaiten_c_2==1:
          kaiten=kaitenhantei(haichi_2,puyo1_2,puyo2_2,1) 
          if kaiten==1:
            puyo1_2[1]-=1
            puyo1_2[2]-=1
          elif kaiten==2:
            ...
            puyo2_2[2]+=1
        if kaiten_c_2==2:
          kaiten=kaitenhantei(haichi_2,puyo1_2,puyo2_2,2)
          if kaiten==1:
            puyo1_2[1]+=1
            puyo1_2[2]-=1
          elif kaiten==2:
      ...
      if countcheck!=counttotal2_2:
        ...
        if zenkeshicount==0:
          zenkeshihyouji_2=1
      if counttotal_a>=70:
        counttotal_a=ojamarakka(haichi_2,counttotal_a)
      if haichi_2[11][2]!=0 :
        pygame.quit()
        sys.exit()
      for event in pygame.event.get():
