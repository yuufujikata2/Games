  ...
  for j in range(12):
    for i in range(6):
      if x[j][i]==1:
        ...
        c=patches.Circle(xy=(i+0.5,j+0.5),radius=0.5,fc='w',ec='k')
        ax.add_patch(c)
def hyouji4(x):
  plt.figure(4)
  pylab.figure(figsize=(6,12))
...
def hyouji2(x):
  ...
  for i in range(8):
    if x[i]==1:
      c=patches.Circle(xy=(0.5,i+0.5),radius=0.5,fc='b',ec='b')
      ax.add_patch(c)
    elif x[i]==2:
      c=patches.Circle(xy=(0.5,i+0.5),radius=0.5,fc='g',ec='g')
      ax.add_patch(c)
    elif x[i]==3:
      c=patches.Circle(xy=(0.5,i+0.5),radius=0.5,fc='r',ec='r')
      ax.add_patch(c)
    elif x[i]==4:
      c=patches.Circle(xy=(0.5,i+0.5),radius=0.5,fc='y',ec='y')
      ax.add_patch(c)
def hyouji3(x,y):
  plt.figure(y)
  ...
  for i in range(6):
    if x[i]==1:
      c=patches.Circle(xy=(i+0.5,0.25),radius=0.25,fc='w',ec='k')
      ax.add_patch(c)
    elif x[i]==2:
      c=patches.Circle(xy=(i+0.5,0.5),radius=0.5,fc='w',ec='k')
      ax.add_patch(c)
    elif x[i]==3:
      c=patches.Circle(xy=(i+0.5,0.5),radius=0.5,fc='r',ec='r')
      ax.add_patch(c)
    elif x[i]==4:
      c=patches.Circle(xy=(i+0.5,0.5),radius=0.5,fc='y',ec='y')
      ax.add_patch(c)
def ojamahyouji(x,y):
    y[0]=0
    y[1]=0
...
def ojamahyouji2(x,y):
    ...
    for i in range(go2,go3):
      y[i]=1
    hyouji3(y,5)
    plt.savefig('/home/harada/python2/result2_puyo3.png')
    plt.close
    ...
    for j in range(1,y):
      for i in range(6):
        if x[j][i]!=0 and x[j-1][i]==0:
          ...
          x[j][i]=0
    hyouji(x)
    plt.savefig('/home/harada/python2/result2_puyo.png')
    time.sleep(1)
    plt.close
    count2+=1
    if count==0:
...
def rensa(x,i):
  ...
  if y==1:
    return 1
  rensa(x,i)
def ojamarakka(x,y,z,nexnex,n01,n02,n1,n2,n3,n4,n5,n6):
  global counttotal2
  while y>2100:
  ...
  if n=='y':
    ...
    if counttotal !=0:
      if zen==1:
        counttotal+=2100
        zen=1
      haichi2=[[0 for i in range(6)] for j in range(13)]
      ojama2=[0,0,0,0,0,0]
      ojamahyouji2(counttotal,ojama2)
      time.sleep(1)
      ojamarakka2(haichi2,counttotal,ojama2)
    zen=zenkeshi(haichi)
  elif n=='r':
    print('return')
    ...
    time.sleep(1)
    ni=ojamarakka(haichi,o_count,ojama,nexnex,n01,n02,n1,n2,n3,n4,n5,n6)
    n01=ni[0]
    n02=ni[1]
    n1=ni[2]
    n2=ni[3]
