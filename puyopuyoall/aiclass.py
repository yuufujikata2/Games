...
#      rensamax=rensamax_2
  ...
  def ai8(self,field,field2,puyo_1,puyo_2):
    ...
    for i in range(22):
      ...
      for j in range(22):
        ...
        kekka[i][j]-=b[1]*4
        kekka[i][j]+=b[2]
        kekka[i][j]+=aifield.rensashirabe2()*1000000
        kekka[i][j]-=(aifield.renketu_c**2)*1000
        aifield.haichi=[[s for s in m] for m in y] #jisakucopy.jisakucopy(y)
    kekka2=kekka.max(axis=1)
    return kekka2.argmax()+1
  ...
  #zenkeshi
  def ai9(self,field,field2,puyo_1,puyo_2):
    kekka=np.zeros((22,22),dtype=np.int)
    aipuyo_1=AIPuyo()
    aipuyo_2=AIPuyo()
    aiterensa_c=0
    ...
    for i in range(22):
      ...
      if aifield.renketusirabe5(aipuyo_1):
        aifield.sokurensa()
        if aifield.rensa_c<=5:
          if aifield.zenkeshishirabe():
            return i+1
        if field.zenkeshihyouji==1:
          return i+1
      for j in range(22):
        aipuyo_2.syokika(puyo_2)
        y=[[s for s in m] for m in aifield.haichi] #jisakucopy.jisakucopy(aifield.haichi)
  ...
  #kikennatokihakka
  def ai10(self,field,field2,puyo_1,puyo_2):
    kekka=np.zeros((22,22),dtype=np.int)
    aipuyo_1=AIPuyo()
    aipuyo_2=AIPuyo()
    aiterensa_c=0
    ...
    for i in range(22):
      ...
      if aifield.shin_rensashirabe()>=7:
        return i+1
      if aifield.renketusirabe5(aipuyo_1):
        chissoku_c=aifield.chissokushirabe()
        aifield.sokurensa()
        chissoku_c2=aifield.chissokushirabe()
        kekka[i]+=chissoku_c-chissoku_c2
        if aifield.rensa_c<=5:
          if aifield.zenkeshishirabe():
            return i+1
        if field.zenkeshihyouji==1:
  ...
  #gtr
  def ai11(self,field,field2,puyo_1,puyo_2):
    kekka=np.zeros((22,22),dtype=np.int)
    aipuyo_1=AIPuyo()
    aipuyo_2=AIPuyo()
    aiterensa_c=0
    ...
    for i in range(22):
      ...
      for j in range(22):
        ...
        aipuyo_2.rakka(aifield.haichi)
        #gtr
        if aifield.haichi[1][1]!=0:
          iro1=aifield.haichi[1][1]
        elif aifield.haichi[1][2]!=0:
          iro1=aifield.haichi[1][2]
        elif aifield.haichi[2][3]!=0:
          iro1=aifield.haichi[2][3]
        elif aifield.haichi[3][2]!=0:
          iro1=aifield.haichi[2][3]
      
        if aifield.haichi[2][1]!=0:
          iro2=aifield.haichi[2][1]
        elif aifield.haichi[2][2]!=0:
          iro2=aifield.haichi[2][2]
        elif aifield.haichi[3][1]!=0:
          iro2=aifield.haichi[1][1]
 
        if aifield.haichi[1][1]==iro1:
          kekka[i][j]+=1000000
        elif aifield.haichi[1][1]!=0 and aifield.haichi[1][1]!=iro1:
          kekka[i][j]-=10000000
        if aifield.haichi[1][2]==iro1:
          kekka[i][j]+=1000000
        elif aifield.haichi[1][2]!=0 and aifield.haichi[1][2]!=iro1:
          kekka[i][j]-=10000000
        if aifield.haichi[2][3]==iro1:
          kekka[i][j]+=1000000
        elif aifield.haichi[2][3]!=0 and aifield.haichi[2][3]!=iro1:
          kekka[i][j]-=10000000
        if aifield.haichi[3][2]==iro1:
          kekka[i][j]+=1000000
        elif aifield.haichi[3][2]!=0 and aifield.haichi[3][2]!=iro1:
          kekka[i][j]-=10000000
        if aifield.haichi[2][1]==iro2:
          kekka[i][j]+=1000000
        elif aifield.haichi[2][1]!=0 and aifield.haichi[2][1]!=iro2:
          kekka[i][j]-=10000000
        if aifield.haichi[2][2]==iro2:
          kekka[i][j]+=1000000
        elif aifield.haichi[2][2]!=0 and aifield.haichi[2][2]!=iro2:
          kekka[i][j]-=10000000
        if aifield.haichi[3][1]==iro2:
          kekka[i][j]+=1000000
        elif aifield.haichi[3][1]!=0 and aifield.haichi[3][1]!=iro2:
          kekka[i][j]-=10000000
   
        if aifield.haichi[3][3]!=0 and aifield.haichi[3][3]==aifield.haichi[2][4]:
          kekka[i][j]+=1000000
...
class FECPU():  
  ...
  def ai10_2_2(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,22)
  def ai10_2_3(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,22)
  def ai10_2_4(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,22)
  def ai10_2_5(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,22)
  def ai10_3_2(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_3_3(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_3_4(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_3_5(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_4_2(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_4_3(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_4_4(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_4_5(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_5_2(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_5_3(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_5_4(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  def ai10_5_5(self,aitefield,field,puyo_1,puyo_2):
    return random.randint(1,20)
  ...
  def cpu_sousa(self,field,puyo):
    ...
    if puyo.puyosuu_c==2:
    ...
    elif puyo.puyosuu_c==3:

      if self.cpu_c==1:
        if field.haichi[13][1]!=0 or field.haichi[13][2]!=0:
          return 0
        if puyo.puyo2x==1 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
            puyo.kaiten_c=1
        ...
        if field.haichi[10][3]!=0 or field.haichi[11][4]!=0:
          return 0           
        if puyo.puyo2x==3 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
        ...
        if field.haichi[12][5]!=0 or field.haichi[10][4]!=0:
          return 0           
        if puyo.puyo2x==4 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
        ...
        if field.haichi[12][5]!=0 or field.haichi[12][6]!=0 or field.haichi[12][4]!=0:
          return 0           
        if puyo.puyo2x==5 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
        ...
        if field.haichi[13][2]!=0 or field.haichi[10][3]!=0:
          return 0
        if puyo.puyo2x==3 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y+1:
            puyo.shita_c+=self.cpu_os()
        ...
        if field.haichi[11][3]!=0 or field.haichi[10][4]!=0:
          return 0           
        if puyo.puyo2x==4 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y+1:
            puyo.shita_c+=self.cpu_os()
        ...
        if field.haichi[12][5]!=0 or field.haichi[11][4]!=0:
          return 0           
        if puyo.puyo2x==5 :
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y+1:
            puyo.shita_c+=self.cpu_os()
        ...
        if puyo.puyo2x==6 :
          ...
          if puyo.puyo3x-1==puyo.puyo2x:
            puyo.kaiten_c=1
          elif puyo.puyo1x-1==puyo.puyo2x:
            puyo.kaiten_c=2
          else:
            puyo.migi_c+=1
        elif  puyo.puyo2x<6 :
        ...
        if field.haichi[13][1]!=0 or field.haichi[13][2]!=0:
          return 0
        if puyo.puyo2x==2:
          if puyo.puyo2x==puyo.puyo1x+1 and puyo.puyo2y==puyo.puyo1y:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
            puyo.kaiten_c=1
    ...
    elif puyo.puyosuu_c==4:
      
      if self.cpu_c==1:
        if field.haichi[13][1]!=0 or field.haichi[13][2]!=0:
          return 0
        if puyo.puyo2x==1 or puyo.puyo1x==1 or puyo.puyo3x==1 or puyo.puyo4x==1:
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
        ...
        if field.haichi[13][2]!=0 or field.haichi[10][3]!=0:
          return 0
        if (puyo.puyo2x==2 or puyo.puyo2x==3) and (puyo.puyo1x==2 or puyo.puyo1x==3) and  (puyo.puyo3x==2 or puyo.puyo3x==3) and (puyo.puyo4x==2 or puyo.puyo4x==3):
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
            puyo.kaiten_c=1
        elif puyo.puyo1x<2 or puyo.puyo2x<2 or puyo.puyo3x<2 or puyo.puyo4x<2:
          puyo.migi_c+=1
        elif puyo.puyo1x>3 or puyo.puyo2x>3 or puyo.puyo3x>3 or puyo.puyo4x>3:
          puyo.hidari_c+=1
        
      elif self.cpu_c==3:
        if field.haichi[10][3]!=0 or field.haichi[10][4]!=0:
          return 0           
        if (puyo.puyo2x==4 or puyo.puyo2x==3) and (puyo.puyo1x==4 or puyo.puyo1x==3) and  (puyo.puyo3x==4 or puyo.puyo3x==3) and (puyo.puyo4x==4 or puyo.puyo4x==3):
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
          ...
          puyo.migi_c+=1
        elif puyo.puyo1x>4 or puyo.puyo2x>4 or puyo.puyo3x>4 or puyo.puyo4x>4:
          puyo.hidari_c+=1

      elif self.cpu_c==4:
        if field.haichi[12][5]!=0 or field.haichi[10][4]!=0:
          return 0           
        if (puyo.puyo2x==4 or puyo.puyo2x==5) and (puyo.puyo1x==4 or puyo.puyo1x==5) and  (puyo.puyo3x==4 or puyo.puyo3x==5) and (puyo.puyo4x==4 or puyo.puyo4x==5):
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
          ...
          puyo.migi_c+=1
        elif puyo.puyo1x>5 or puyo.puyo2x>5 or puyo.puyo3x>5 or puyo.puyo4x>5:
          puyo.hidari_c+=1

      elif self.cpu_c==5:
        if field.haichi[12][5]!=0 or field.haichi[12][6]!=0 or field.haichi[12][4]!=0:
          return 0           
        if (puyo.puyo2x==6 or puyo.puyo2x==5) and (puyo.puyo1x==6 or puyo.puyo1x==5) and  (puyo.puyo3x==6 or puyo.puyo3x==5) and (puyo.puyo4x==6 or puyo.puyo4x==5):
          if puyo.puyo2x==puyo.puyo1x and puyo.puyo2y==puyo.puyo1y-1:
            puyo.shita_c+=self.cpu_os()
            return 1
          else:
          ...
          puyo.migi_c+=1
        elif puyo.puyo1x>6 or puyo.puyo2x>6 or puyo.puyo3x>6 or puyo.puyo4x>6:
          puyo.hidari_c+=1
      ...
      if self.cpu_c==1:
        ...
        if puyo.puyo2x==2:
          ...
          if field.haichi[puyo.puyo4y][puyo.puyo4x+1]!=0:
            return 0
          else:
            puyo.migi_c+=1

      elif self.cpu_c==3:
        if  field.haichi[10][2]!=0 or field.haichi[13][4]!=0:
          return 0
        if puyo.puyo2x==3:
          if puyo.puyo1iro!=1:
            puyo.kaiten_c=1
          ...
          if field.haichi[puyo.puyo4y][puyo.puyo4x+1]:
            return 0
          else:
            puyo.migi_c+=1
