...
class Field():
  ...
  def ojamarakka_f(self,aitefield):
    if aitefield.counttotal_a>=3600:
      self.haichi.append([0,0,0,0,0,0,0,0])
      self.haichi.append([0,0,0,0,0,0,0,0])
      self.haichi.append([0,0,0,0,0,0,0,0])
      self.haichi.append([0,0,0,0,0,0,0,0])
      self.haichi.append([0,0,0,0,0,0,0,0])
      aitefield.counttotal_a-=3600
      for j in range(14,19):
        for i in range(1,7):
          self.haichi[j][i]=5
      self.sokurakka(19)
      ...
      self.haichi.append([0,0,0,0,0,0,0,0])
      self.haichi.append([0,0,0,0,0,0,0,0])
      y1=aitefield.counttotal_a//120
      y2=aitefield.counttotal_a%120
      aitefield.counttotal_a=y2
      if y1>24:
        for j in range(14,18):
          for i in range(1,7):
  ...
  def ferensa(self,aitefield,fever,aitefever,ff):
    ff2=0
    if aitefever.fehantei:
      ff2=1
    j=self.renketukeshi2_f()
    if j[0]!=0:
      self.rensa_c+=1
    count=0
    if self.rensa_c==1:
    ...
    if j[0]!=0:
      if ff2==1 and ff==1:
        if aitefield.counttotal==0 and aitefield.counttotal_a==0:
          self.counttotal_f+=j[0]*k*10
          self.counttotal2+=j[0]*k*10
          if j[0]!=0 and self.counttotal_r!=0:
            self.counttotal_f+=self.counttotal_r
            self.counttotal_r=0
        elif aitefield.counttotal==0:
          aitefield.counttotal_a-=j[0]*k*10
          self.counttotal2+=j[0]*k*10
          ...
          if j[0]!=0 and self.counttotal_r!=0:
            ...
            self.counttotal_r=0
          if aitefield.counttotal_a<0:
            self.counttotal_f-=aitefield.counttotal_a
            aitefield.counttotal_a=0
        else:
          aitefield.counttotal-=j[0]*k*10
          self.counttotal2+=j[0]*k*10
    ...
    if aa==1:
      return 1
    self.ferensa(aitefield,fever,aitefever,ff)


  def ferensa_f(self,aitefield,fever,aitefever,ff):
    j=self.renketukeshi2_f()
    ff2=0
    if aitefever.fehantei:
      ff2=1
    ...
    if k==0:
      k=1
    if ff==1 and ff2==1:
      if aitefield.counttotal==0 and aitefield.counttotal_a==0 and aitefield.counttotal_f==0:
        self.counttotal_f+=j[0]*k*10
        self.counttotal2+=j[0]*k*10
        if j[0]!=0 and self.counttotal_r!=0:
          self.counttotal_f+=self.counttotal_r
          self.counttotal_r=0
      elif aitefield.counttotal==0 and aitefield.counttotal_a==0:
        aitefield.counttotal_f-=j[0]*k*10
        self.counttotal2+=j[0]*k*10
        if j[0]!=0 and self.counttotal_r!=0:
          aitefield.counttotal_f-=self.counttotal_r
          self.counttotal_r=0
        if aitefield.counttotal_f<0:
          self.counttotal_f-=aitefield.counttotal_f
          aitefield.counttotal_f=0
        ...
        if j[0]!=0 and self.counttotal_r!=0:
          ...
          self.counttotal_r=0
        if aitefield.counttotal_a<0:
          aitefield.counttotal_f-=aitefield.counttotal_a
          aitefield.counttotal_a=0
        if aitefield.counttotal_f<0:
          self.counttotal_f-=aitefield.counttotal_f
          aitefield.counttotal_f=0
      ...
      if aitefield.counttotal==0 and aitefield.counttotal_a==0 and aitefield.counttotal_f==0:
        ...
        if j[0]!=0 and self.counttotal_r!=0:
          ...
          self.counttotal_r=0
        if aitefield.counttotal_f<0:
          self.counttotal-=aitefield.counttotal_f
          aitefield.counttotal_f=0
    ...
    if aa==1:
      return 1
    self.ferensa_f(aitefield,fever,aitefever,ff)
